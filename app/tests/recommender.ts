...
const popularProductsTest = new ProductRecommendationTest(
...
const recentlyViewedProductsTest = new ProductRecommendationTest(
    "Recently Viewed Products Recommendation",
    () => recommender.recentlyViewedProducts({
        language: {
            value: 'da-dk'
        },
        filters: {},
...
const personalProductRecommendationTest = new ProductRecommendationTest(
    "Personal Product Recommendation",
    () => recommender.personalProductRecommendation({
        language: {
            value: 'da-dk'
        },
        filters: {},
